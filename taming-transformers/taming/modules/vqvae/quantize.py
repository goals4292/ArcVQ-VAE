...
class VectorQuantizer2(nn.Module):
    ...
    def __init__(self, n_e, e_dim, beta, remap=None, unknown_index="random",
                 sane_index_shape=False, legacy=True, bbnr_alpha=0.00005):
        super().__init__()
        self.n_e = n_e
        self.e_dim = e_dim
        self.beta = beta
        self.legacy = legacy
        self.bbnr_alpha = bbnr_alpha
    ...
    # BBNR
    def clip_codebook_norms(self, step, alpha=0.00005):
        if step is None:
            return
        with torch.no_grad():
    ...
    def forward(self, z, temp=None, rescale_logits=False, return_logits=False, step=None):
        self.clip_codebook_norms(step, alpha=self.bbnr_alpha)
