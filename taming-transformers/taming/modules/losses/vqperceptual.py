...
class ArcLoss(nn.Module):
    def __init__(self, s=10.0, m=0.1, top_k=3):
        super().__init__()
        self.s = s
        self.m = m
        self.top_k = top_k
...
class VQLPIPSWithDiscriminator(nn.Module):
    def __init__(self, disc_start, codebook_weight=1.0, pixelloss_weight=1.0,
                 ...
                 disc_ndf=64, disc_loss="hinge", arc_gamma=1.0, arc_gamma_decay=1e-4,
                 arc_s=10.0, arc_m=0.1, arc_top_k=3):
        super().__init__()
        ...
        # ArcLoss
        self.arc_loss = ArcLoss(s=arc_s, m=arc_m, top_k=arc_top_k)
